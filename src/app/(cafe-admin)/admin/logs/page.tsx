...
export default function CafeLogsPage() {
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-gray-900 tracking-tight flex items-center gap-3">
                        ...
                        Outlet Activity Logs
                    </h1>
                    <p className="text-gray-500 mt-2 font-medium max-w-xl">
                        Monitor local shop referrals, guest redemptions, and recent partner activities for this outlet.
                    </p>
                </div>
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-3xl border border-dashed border-gray-300">
                        ...
                        <p className="font-black text-gray-400 uppercase tracking-widest">No activity found</p>
